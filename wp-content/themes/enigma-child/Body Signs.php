...
<!-- The Function of this page is to display Check-up Body Sign, which will show all organs and question to clarify what have been injured until now-->

<?php /*Template Name: Body Signs*/ ?>
			...
			<div class="col-md-12">
				<h1>
					<?php 
						global $current_user;
      					get_currentuserinfo();
						echo $current_user->display_name. "'s Body Signs";
					?>
...
<div id="External-Organ">
		...
		<div id="Head-Area"> <!-- Head Area -->
			
			<div align="center" style="font-size: 30px;"> <label class="col-xs-12" style="color:cornflowerblue;">Head Area</label> </div> <!-- Head Label -->
			<?php $i=1; while($i<5){echo'<br/>'; $i++;} ?>	
			
			<div id="Emotion-Section" class="form-group"> <!-- Emotion Section -->
				<div class="col-xs-10 table-responsive">
				 	<table class="table">
				 		<tr>
							<?php
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/beauty.png" title="Beauty" alt="Beauty" /></td> ';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/big_smile.png" title="big_smile" alt="big_smile" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/smile.png" title="smile" alt="smile" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/haha.png" title="haha" alt="haha" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/sure.png" title="sure" alt="sure" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/confuse.png" title="confuse" alt="confuse" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/angry.png" title="angry" alt="angry" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/tire.png" title="tire" alt="tire" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/sad.png" title="sad" alt="sad" /></td>';
							echo '<td><img width="50" src="'; ?> <?php echo get_stylesheet_directory_uri().'//Body_Signs/Images/too_sad.png" title="too_sad" alt="too_sad" />';
							?>
						</tr>
						<tr>
							<td><label class="radio-inline"><input value="Beauty" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="big_smile" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="smile" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="haha" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="sure" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="confuse" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="angry" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="tire" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="sad" type="radio" name="feeling_icon" ></label></td>
							<td><label class="radio-inline"><input value="too_sad" type="radio" name="feeling_icon" ></label></td>
						</tr>
					</table>
						
 						
				</div>
			</div><!-- End Emotion Section-->

		
			<div id="Head-Section" class="form-group"> 
				<div class="col-xs-5"><!-- Head Section -->
				
				
					<p><!-- Feeling Section -->
						<label for="feeling">Feeling Tension Scale:</label>
						<input type="text" name="feeling" id="feeling" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>

						<div id="slider-feeling"></div><!-- End Feeling Section -->	<br/>
					
					
				 	<p>
 						<label for="head">Head Tension Scale:</label>
  						<input type="text" name="head" id="head" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
		...
		<?php $i=1; while($i<3){echo'<br/>'; $i++;} ?>	
		<div id="Body-Area"> <!-- Body Area -->
			<div align="center" style="font-size: 30px;"> <label class="col-xs-12" style="color:cornflowerblue;">Body Area</label> </div> <!-- Body Label -->
			
			
			<div id="Neck-Chest-Section" class="form-group"> <!-- Neck + Chest Section -->
				<div class="col-xs-5"> <!-- Neck Area -->
			 	
				 	<p>
 						<label for="neck">Neck Tension Scale:</label>
  						<input type="text" name="neck" id="neck" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-neck"></div>
 						
				</div><!-- End Neck Area -->
				
				
				<div class="col-xs-5"> <!-- Chest Area -->
			 	
				 	<p>
 						<label for="chest">Chest Tension Scale:</label>
  						<input type="text" name="chest" id="chest" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-chest"></div>
 						
				</div><!-- End Chest Area -->
				
			</div><!-- End Neck + Chest Section-->
			
			
			
			<div id="Abdomen-Shoulder-Section" class="form-group"> <!-- Abdomen + Shoulder Section -->
				<div class="col-xs-5"> <!-- Abdomen Area -->
			 	
				 	<p>
 						<label for="abdomen">Abdomen Tension Scale:</label>
  						<input type="text" name="abdomen" id="abdomen" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-abdomen"></div>
 						
				</div><!-- End Abdomen Area -->
			
				
				<div class="col-xs-5"> <!-- Shoulder Area -->
			 	
				 	<p>
 						<label for="shoulder">Shoulder Tension Scale:</label>
  						<input type="text" name="shoulder" id="shoulder" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-shoulder"></div>
 						
				</div><!-- End Shoulder Area -->
				
			</div><!-- End Abdomen + Shoulder Section-->
			
			
			
			<div id="Arm-Section" class="form-group"> <!-- Arm Section -->
				<div class="col-xs-5"> <!-- Abdomen Area -->
			 	
				 	<p>
 						<label for="arm">Arm Tension Scale:</label>
  						<input type="text" name="arm" id="arm" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-arm"></div>
		...
		<?php $i=1; while($i<3){echo'<br/>'; $i++;} ?>	
		<div id="Limbs-Area"> <!-- Limbs Area -->
		
			<div align="center" style="font-size: 30px;"> <label class="col-xs-12" style="color:cornflowerblue;">Limbs Area</label> </div> <!-- Limbs Label -->
			
			<div id="Limb-Section" class="form-group"> <!--Upper + Lower Limbs Section -->
				<div class="col-xs-5"> <!-- Upper Limb Area -->
			 	
				 	<p>
 						<label for="upper-limb">Upper Limb Tension Scale:</label>
  						<input type="text" name="upperlime" id="upper-limb" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-upper-limb"></div>
 						
				</div><!-- End Upper Limb Area -->
				
				
				<div class="col-xs-5"> <!-- Lower Limb Area -->
			 	
				 	<p>
 						<label for="lower-limb">Lower Limb Tension Scale:</label>
  						<input type="text" name="lowerlimb" id="lower-limb" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-lower-limb"></div>
 						
				</div><!-- End Lower Limb Area -->
				
			</div><!-- End Upper + Lower Limbs Section-->
			
			
			
			<div id="Leg-Hand-Section" class="form-group"> <!-- Leg + Hand Section -->
				<div class="col-xs-5"> <!-- Abdomen Area -->
			 	
				 	<p>
 						<label for="leg">Leg Tension Scale:</label>
  						<input type="text" name="leg" id="leg" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-leg"></div>
 						
				</div><!-- End Abdomen Area -->
				
				
				<div class="col-xs-5"> <!-- Hand Area -->
			 	
				 	<p>
 						<label for="hand">Hand Tension Scale:</label>
  						<input type="text" name="hand" id="hand" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-hand"></div>
 						
				</div><!-- End Hand Area -->
				
			</div><!-- End Leg + Hand Section-->
			
		</div> <!-- End Limbs Area -->

</div>	<!-- End External Organs -->



<div id="Internal-Organ" style="margin-top: 10%;"> <!-- Beginning External Organs -->

	<div id="Lung-Heart-Stomach-Area"> <!-- Lung + Heart + Stormach Section -->
	
		<div align="center" style="font-size: 30px;"> <label class="col-xs-12" style="color:cornflowerblue;">Internal Area</label> </div> <!-- Body Label -->


			<div id="Thought-Section" class="form-group"> <!-- Thought Section -->
				<div class="col-xs-10">
				 	<p>
						<label for="thought-area">Your Thought:</label>
						<textarea class="form-control" rows="7" name="thought-area" id="thought-area"></textarea>
					</p>
 						
				</div>
			</div><!-- End Thought Section-->
			
						
								
			<div id="Lungs-Thought-Section" class="form-group"> <!--Lung-Thought Section -->
				<div class="col-xs-5"> <!-- Lungs Area -->
			 	
				 	<p>
 						<label for="lungs">Lungs Tension Scale:</label>
  						<input type="text" name="lungs" id="lungs" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-lungs"></div>
 						
				</div><!-- End Lungs Area -->
				
				<div class="col-xs-5"> <!-- Thought Area -->
			 	
				 	<p>
 						<label for="thought">Thought Tension Scale:</label>
  						<input type="text" name="thought" id="thought" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-thought"></div>
 						
				</div><!-- End Thought Area -->
				
			</div><!-- End Lungs-Thought Section-->
		
		

			
			
			<div id="Heart-Stomach-Section" class="form-group"> <!--Heart-Stomach Area -->
				<div class="col-xs-5"> <!-- Heart Area -->
			 	
				 	<p>
 						<label for="heart">Heart Tension Scale:</label>
  						<input type="text" name="heart" id="heart" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-heart"></div>
 						
				</div>
			
			

				<div class="col-xs-5"><!-- Stomach Area -->
			 	
				 	<p>
 						<label for="stomach">Stomach Tension Scale:</label>
  						<input type="text" name="stomach" id="stomach" readonly style="border:0; color:#f6931f; font-weight:bold;"/>
					</p>
 						
 						<div id="slider-stomach"></div>
 						
				</div><!-- End Stomach Area -->
				
			</div><!-- End Heart-Stomach Area -->
			
	</div><!-- End Lung + Heart + Stormach Section -->
	
</div><!-- End External Organs -->
		<button id="Calculate" type="submit" class="btn btn-success btn-md"style="float:right;  margin-right: 17%; margin-top: 5%;" >Calculate</button>
		<button data-toggle="tooltip" title="Click to Jump to Next Body Part!" onClick="NextBody();" id="Next" type="button" class="btn btn-primary btn-md" style="float:right; margin-right: 17%; margin-top: 5%;">Next</button>
		<button data-toggle="tooltip" title="Back to previous Body Part!" onClick="PreviousBody();" id="Previous" type="button" class="btn btn-primary btn-md" style="float: right; margin-right: 2%; margin-top: 5%;">Previous</button>
		
		
	
	</form>
</div><!-- End <!-- Form to Input Organs Information  -->
</div><!-- End row Bootstrap -->
