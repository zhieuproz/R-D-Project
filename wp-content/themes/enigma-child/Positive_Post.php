<!-- this page is the sub page of therapy page which is used for User Function : User's Positive Timeline Function !!!
<!-- this page is the separated page and using same template of the website : Enigma -->
<?php /*Template Name: Positive Posts*/ ?>
...
<div class="container">	 <!-- Main Timeline function -->
	<div class="row enigma_blog_wrapper">
		<div class="col-md-12">
     		...
     		<div id="titlename"> <h1 style="font-size:25px; color:#900;"> Positive Timeline </h1></div>
        
    	<?php 
			$Name = $current_user->display_name; //getting current user to variable name to use !!
			include("Database/ConnectDatabase.php");
			$GLOBALS['Check_Attitude'] = 1 ;
			$sql = mysqli_query($conn,"select * from timeline where User_Identify like '$Name' and Attitude like 'Positive' ");
			if(mysqli_num_rows($sql) != 0) 
			{
									...
									Show_Timeline(); // this function is called from function.php of enigma-child folder
